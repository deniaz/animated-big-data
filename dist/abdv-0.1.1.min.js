...
var Visualization=function(){"use strict";function t(t){b=t.paper,k=t.nodes,x=t.links,E=t.normalize,V=t.threshold,e(),i(),j.forEach(function(t){d(t._node)&&m(t),u(t),l(t)})}function e(){x.forEach(function(t){var e=t.source.x,i=t.source.y,n=t.target.x,a=t.target.y;"attribute"===t.source.type&&(e+=q/2,i+=C/2),"attribute"===t.target.type&&(n+=q/2,a+=C/2);var r=b.line(e,i,n,a);r.attr({stroke:T,opacity:0}),t._ui=r,t.source._links?t.source._links.push(t):t.source._links=[t],t.target._links?t.target._links.push(t):t.target._links=[t]})}function i(){k.forEach(function(t){var e=n();"frequency"===t.type?(e.append(a(t)),e.append(o(t)),e.append(s(t))):"attribute"===t.type&&(t.activeLinks=0,e.append(r(t)),e.append(c(t))),t._ui=e,e._node=t,j.push(e)})}function n(){var t=b.group();return t.attr({opacity:0}),t._isVisible=!1,t}function a(t){var e=E(t.intervals[0].percentage),i=b.circle(t.x,t.y,e);return i.attr({fill:W}),i}function r(t){var e=b.rect(t.x,t.y,q,C);return e.attr({fill:B}),e}function o(t,e){e||(e=0);var i=t.intervals[e].percentage.toFixed(2)+"%";return b.text(t.x-15,t.y-10,i).addClass("bold percentage")}function s(t,e){e||(e=0);var i="("+t.intervals[e].label+")";return b.text(t.x-25,t.y+10,i).addClass("freq-id")}function c(t){return b.text(t.x+10,t.y+28,t.label)}function u(t){var e=t._node;t.drag(function(i,n,a,r){this.attr({transform:this.data("transform")+(this.data("transform")?"T":"t")+[i,n]}),e.x=a,e.y=r;var o=t.getBBox();e._links.forEach(function(t){t.source===e?t._ui.attr({x1:o.cx,y1:o.cy}):t.target===e&&t._ui.attr({x2:o.cx,y2:o.cy})})},function(){this.data("transform",this.transform().local)})}function l(t){"frequency"===t._node.type?f(t):_(t)}function f(t){var e=t.select("circle"),i=t._node._links.map(function(t){return t.target._ui.select("rect")}),n=t._node._links.map(function(t){return t._ui});t.hover(function(){t._isVisible&&(e.animate({fill:L},250,mina.easeinout),i.forEach(function(t){t.animate({fill:z},250,mina.easeinout)}),n.forEach(function(t){t.animate({fill:F,strokeWidth:2},250,mina.easeinout)}))},function(){e.animate({fill:W},250,mina.easeinout),i.forEach(function(t){t.animate({fill:B},250,mina.easeinout)}),n.forEach(function(t){t.animate({fill:T,strokeWidth:1},250,mina.easeinout)})})}function _(t){var e=t.select("rect"),i=t._node._links.map(function(t){return t.source._ui.select("circle")}),n=t._node._links.map(function(t){return t._ui});t.hover(function(){t.isVisible&&(e.animate({fill:z},250,mina.easeinout),i.forEach(function(t){t.animate({fill:L},250,mina.easeinout)}),n.forEach(function(t){t.animate({fill:F,strokeWidth:2},250,mina.easeinout)}))},function(){e.animate({fill:B},250,mina.easeinout),i.forEach(function(t){t.animate({fill:W},250,mina.easeinout)}),n.forEach(function(t){t.animate({fill:T,strokeWidth:1},250,mina.easeinout)})})}function d(t,e){return e||(e=0),"frequency"===t.type&&t.intervals[e]?t.intervals[e].percentage>=V:!1}function m(t){t._isVisible||v(t)}function p(t){t._isVisible&&v(t)}function v(t){t._isVisible=!t._isVisible,t._node._links.forEach(function(e){var i=!t._isVisible&&1===e.target.activeLinks||t._isVisible&&0===e.target.activeLinks;i&&e.target._ui.animate({opacity:t._isVisible?1:0},500,mina.easeinout).toggleClass("is-visible"),t._isVisible?e.target.activeLinks++:e.target.activeLinks--,e._ui.animate({opacity:t._isVisible?1:0},500,mina.easeinout)}),t.animate({opacity:t._isVisible?1:0},500,mina.easeinout).toggleClass("is-visible")}function h(t,e){var i=E(t._node.intervals[e].percentage);t.select("circle").animate({r:i},500,mina.easeinout)}function y(t,e){var i=t.select(".percentage");i.node.textContent=t._node.intervals[e].percentage.toFixed(2)+"%";var n=t.select(".freq-id");n.node.textContent="("+t._node.intervals[e].label+")"}function g(t){j.forEach(function(e){"frequency"===e._node.type&&(e._node.intervals[t]&&(y(e,t),h(e,t)),d(e._node,t)?m(e):p(e))})}var b,k,x,E,V,q=120,C=45,L="#3498db",W="#2980b9",z="#e74c3c",B="#c0392b",F="#34495e",T="#2c3e50",j=[];return{start:t,next:g,setThreshold:function(t){V=t}}}();
