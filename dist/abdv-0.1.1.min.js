...
var LayoutEngine=function(){"use strict";function n(){this.nodes=[],this.links=[]}function e(){return L}function r(){return B}function t(e,r,t,i){x=u(e),q=r,k=t,N=i;var a=o(),f=s(a);l(f);var d=new n;h(d),v(d),L=d.nodes,B=d.links}function u(e){var r=new n,t=[];return e.forEach(function(n){for(var e=n[n.length-1],u=[],o=0;o<n.length-1;o++){var i;r.containsNode(n[o])?(i=r.nodes[r.getKey(n[o])],i.numberOfLinks++):(i=r.nodes[r.nodes.push(n[o])-1],i.numberOfLinks=1),u.push(i)}t.push({frequency:e,attributes:u})}),t}function o(){for(var n=[],e=0;e<x.length-1;e++)for(var r=e+1;r<x.length;r++){var t={indexA:e,indexB:r,equal:i(x[e],x[r])};n.push(t)}return n.forEach(function(n,e){n.index=e}),n.sort(function(n,e){return n.equal<e.equal?1:n.equal>e.equal?-1:n.index<e.index?-1:n.index>e.index?1:0}),n}function i(n,e){for(var r=0,t=0;t<n.attributes.length;t++)for(var u=0;u<e.attributes.length;u++)if(e.attributes[u].id==n.attributes[t].id){r++;break}return r}function s(n){for(var e=[],r=0;r<n.length;r++){for(var t=n[r],u=x[t.indexA].frequency,o=x[t.indexB].frequency,i=!1,s=0;s<O.length;s++)if(O[s].frequency.label==u.label||O[s].frequency.label==o.label){i=!0;break}i||e.push(a(x[t.indexA],x[t.indexB]))}if(x.length%2!==0)for(var r=0;r<x.length;r++){for(var l=!1,s=0;s<O.length;s++)if(x[r].frequency.label==O[s].frequency.label){l=!0;break}l||e.push(a(x[r],null))}return e}function a(n,e){var r={subGraphA:n,subGraphB:e};return O.push(r.subGraphA),null!==r.subGraphB&&O.push(r.subGraphB),r}function l(e){for(var r=0;r<e.length;r++){var t=e[r].subGraphA.attributes,u=new n,o=f(t,u);G.push(o.single),null!==e[r].subGraphB&&(t=e[r].subGraphB.attributes,o=f(t,u),G.push(o.single)),o.multi.nodes.forEach(function(n,e){n.index=e}),o.multi.nodes.sort(function(n,e){return n.numberOfLinks>e.numberOfLinks?1:n.numberOfLinks<e.numberOfLinks?-1:n.index>e.index?1:n.index<e.index?-1:0});for(var i=0;i<o.multi.nodes.length;i++)A.addNode(o.multi.nodes[i])}}function f(n,e){for(var r=[],t=0;t<n.length;t++)1==n[t].numberOfLinks?r.push(n[t]):e.addNode(n[t]);return{single:r,multi:e}}function h(n){for(var e=d(),r=c(e),t=0,u=0;u<A.nodes.length;u++)A.nodes[u].x=r.column3,A.nodes[u].y=t,t+=y+b,n.addNode(A.nodes[u]);var o=A.nodes.length;t=(o*y+(o-1)*b)/2;for(var u=0;u<O.length;u++){var i=O[u].frequency,s=G[u].length;if(u%2===0){i.x=r.column2;for(var a=0;s>a;a++)G[u][a].x=r.column1}else{i.x=r.column4;for(var a=0;s>a;a++)G[u][a].x=r.column5}u>=2&&(t+=2*e+m),i.y=t;for(var l=t-(s*y+(s-1)*b)/2,a=0;s>a;a++)G[u][a].y=l,n.addNode(G[u][a]),l+=y+b;n.addNode(i)}g(n,e)}function d(){for(var n=N(O[0].frequency.intervals[0].percentage),e=0;e<O.length;e++)for(var r=0;r<O[e].frequency.intervals.length;r++){var t=N(O[e].frequency.intervals[r].percentage);t>n&&(n=t)}return n}function c(n){var e=q/2-p/2,r=e-m-n,t=r-n-m-p,u=e+p+m+n,o=u+n+m;return{column1:t,column2:r,column3:e,column4:u,column5:o}}function g(n,e){var r=O.length-1,t=G[r].length-1,u=[];u.push(G[r][t].y+y),u.push(O[O.length-1].frequency.y+e),u.push(A.nodes[A.nodes.length-1].y+y),O.length>1&&(r=O.length-2,t=G[r].length-1,u.push(G[r][t].y+y),u.push(O[O.length-2].frequency.y+e));for(var o=u[0],i=1;i>u.length;i++)u[i]>o&&(o=u[i]);for(var s=(k-o)/2,i=0;i<n.nodes.length;i++)n.nodes[i].y+=s}function v(n){for(var e=0;e<O.length;e++)for(var r=0;r<O[e].attributes.length;r++)n.link(O[e].frequency,n.nodes[n.getKey(O[e].attributes[r])])}var p=120,y=45,b=15,m=50;n.prototype.getKey=function(n){for(var e=0;e<this.nodes.length;e++){var r=this.nodes[e];if(r.id&&n.id&&r.id===n.id)return e}throw Error("Element not found.")},n.prototype.containsNode=function(n){try{return this.getKey(n),!0}catch(e){return!1}},n.prototype.addNode=function(n){return this.containsNode(n)?this.nodes[this.getKey(n)]:this.nodes[this.nodes.push(n)-1]},n.prototype.link=function(n,e){this.links.push({source:n,target:e})};var x,q,k,N,L=[],B=[],G=[],A=new n,O=[];return{getNodes:e,getLinks:r,buildFromArray:t}}();
...
var Hypergraph=function(t){"use strict";function n(t){t||(t="data.json");var n=new XMLHttpRequest;n.open("GET",t,!0),n.onload=function(){if(this.status>=200&&this.status<400){var t=JSON.parse(this.response);t.forEach(function(t){var n=t[t.length-1];f=n.intervals.length>f?n.intervals.length-1:f}),w.buildFromArray(t,g,v,function(t){return 2*t}),e()}},n.send()}function e(){var t=w.getNodes(),n=w.getLinks(),e=document.createElementNS("http://www.w3.org/2000/svg","svg");e.setAttribute("height",v),e.setAttribute("width",g),p.appendChild(e),s=Visualization,s.start({paper:new Snap(e),nodes:t,links:n,normalize:function(t){return 1.5*Math.pow(t,2)},threshold:c})}function i(){u||(u=!u,d=window.setInterval(a,l))}function r(){u&&(u=!u,window.clearInterval(d),d=null)}function o(t){return l=t,u&&(r(),i()),l}function a(){h===f?(document.dispatchEvent(new Event("animation.finished")),window.clearInterval(d),h=0,u=!1,s.next(h)):s.next(++h)}var s,u=!1,l=2500,c=5,h=0,d=null,f=0,w=t,p=null,v=0,g=0;return{start:function(t,e){p=document.querySelector(t),v=window.innerHeight,g=p.offsetWidth,n(e)},isPlaying:function(){return u},play:i,pause:r,changeVelocity:o,setThreshold:function(t){c=t,s.setThreshold(t)}}}(LayoutEngine);