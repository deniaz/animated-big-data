...
var Visualization=function(){"use strict";function t(t){b=t.paper,k=t.nodes,x=t.links,V=t.normalize,E=t.threshold,i(),e(),j.forEach(function(t){d(t._node)&&m(t),u(t),l(t)})}function i(){x.forEach(function(t){var i=t.source.x,e=t.source.y,n=t.target.x,a=t.target.y;"attribute"===t.source.type&&(i+=q/2,e+=C/2),"attribute"===t.target.type&&(n+=q/2,a+=C/2);var r=b.line(i,e,n,a);r.attr({stroke:T,opacity:0}),t._ui=r,t.source._links?t.source._links.push(t):t.source._links=[t],t.target._links?t.target._links.push(t):t.target._links=[t]})}function e(){k.forEach(function(t){var i=n();"frequency"===t.type?(i.append(a(t)),i.append(o(t)),i.append(s(t))):"attribute"===t.type&&(t.activeLinks=0,i.append(r(t)),i.append(c(t))),t._ui=i,i._node=t,j.push(i)})}function n(){var t=b.group();return t.attr({opacity:0}),t._isVisible=!1,t}function a(t){var i=V(t.intervals[0].percentage),e=b.circle(t.x,t.y,i);return e.attr({fill:W}),e}function r(t){var i=b.rect(t.x,t.y,q,C);return i.attr({fill:B}),i}function o(t,i){i||(i=0);var e=t.intervals[i].percentage.toFixed(2)+"%";return b.text(t.x-15,t.y-10,e).addClass("bold percentage")}function s(t,i){i||(i=0);var e="("+t.intervals[i].label+")";return b.text(t.x-25,t.y+10,e).addClass("freq-id")}function c(t){return b.text(t.x+10,t.y+28,t.label)}function u(t){var i=t._node;t.drag(function(e,n,a,r){this.attr({transform:this.data("transform")+(this.data("transform")?"T":"t")+[e,n]}),i.x=a,i.y=r;var o=t.getBBox();i._links.forEach(function(t){t.source===i?t._ui.attr({x1:o.cx,y1:o.cy}):t.target===i&&t._ui.attr({x2:o.cx,y2:o.cy})})},function(){this.data("transform",this.transform().local)})}function l(t){"frequency"===t._node.type?f(t):_(t)}function f(t){var i=t.select("circle"),e=t._node._links.map(function(t){return t.target._ui.select("rect")}),n=t._node._links.map(function(t){return t._ui});t.hover(function(){t._isVisible&&(i.animate({fill:L},250,mina.easeinout),e.forEach(function(t){t.animate({fill:z},250,mina.easeinout)}),n.forEach(function(t){t.animate({fill:F,strokeWidth:2},250,mina.easeinout)}))},function(){i.animate({fill:W},250,mina.easeinout),e.forEach(function(t){t.animate({fill:B},250,mina.easeinout)}),n.forEach(function(t){t.animate({fill:T,strokeWidth:1},250,mina.easeinout)})})}function _(t){var i=t.select("rect"),e=t._node._links.map(function(t){return t.source._ui.select("circle")}),n=t._node._links.map(function(t){return t._ui});t.hover(function(){t._isVisible&&(i.animate({fill:z},250,mina.easeinout),e.forEach(function(t){t.animate({fill:L},250,mina.easeinout)}),n.forEach(function(t){t.animate({fill:F,strokeWidth:2},250,mina.easeinout)}))},function(){i.animate({fill:B},250,mina.easeinout),e.forEach(function(t){t.animate({fill:W},250,mina.easeinout)}),n.forEach(function(t){t.animate({fill:T,strokeWidth:1},250,mina.easeinout)})})}function d(t,i){return i||(i=0),"frequency"===t.type&&t.intervals[i]?t.intervals[i].percentage>=E:!1}function m(t){t._isVisible||v(t)}function p(t){t._isVisible&&v(t)}function v(t){t._isVisible=!t._isVisible,t._node._links.forEach(function(i){var e=!t._isVisible&&1===i.target.activeLinks||t._isVisible&&0===i.target.activeLinks;e&&(i.target._ui.animate({opacity:t._isVisible?1:0},500,mina.easeinout).toggleClass("is-visible"),i.target._ui._isVisible=t._isVisible),t._isVisible?i.target.activeLinks++:i.target.activeLinks--,i._ui.animate({opacity:t._isVisible?1:0},500,mina.easeinout)}),t.animate({opacity:t._isVisible?1:0},500,mina.easeinout).toggleClass("is-visible")}function h(t,i){var e=V(t._node.intervals[i].percentage);t.select("circle").animate({r:e},500,mina.easeinout)}function g(t,i){var e=t.select(".percentage");e.node.textContent=t._node.intervals[i].percentage.toFixed(2)+"%";var n=t.select(".freq-id");n.node.textContent="("+t._node.intervals[i].label+")"}function y(t){j.forEach(function(i){"frequency"===i._node.type&&(i._node.intervals[t]&&(g(i,t),h(i,t)),d(i._node,t)?m(i):p(i))})}var b,k,x,V,E,q=120,C=45,L="#3498db",W="#2980b9",z="#e74c3c",B="#c0392b",F="#34495e",T="#2c3e50",j=[];return{start:t,next:y,setThreshold:function(t){E=t}}}();
