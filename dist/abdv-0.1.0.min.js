...
var LayoutEngine=function(){"use strict";function n(n){return Math.pow(n,4)/30}function e(){this.nodes=[],this.links=[]}function r(){return x}function t(){return G}function u(n,r,t){m=n,q=r,k=t;var u=o(),a=s(u);i(a);var l=new e;f(l),g(l),x=l.nodes,G=l.links}function o(){for(var n=[],e=0;e<m.length-1;e++)for(var r=e+1;r<m.length;r++){var t={indexA:e,indexB:r,equal:a(m[e],m[r])};n.push(t)}return n.sort(function(n,e){return n.equal<e.equal?1:n.equal>e.equal?-1:0}),n}function a(n,e){for(var r=0,t=0;t<n.attributes.length;t++)for(var u=0;u<e.attributes.length;u++)if(e.attributes[u].id==n.attributes[t].id){r++;break}return r}function s(n){for(var e=[],r=0;r<n.length;r++){for(var t=n[r],u=m[t.indexA].frequency,o=m[t.indexB].frequency,a=!1,s=0;s<B.length;s++)if(B[s].frequency.label==u.label||B[s].frequency.label==o.label){a=!0;break}if(!a){var i={subGraphA:m[t.indexA],subGraphB:m[t.indexB]};e.push(i),B.push(i.subGraphA),B.push(i.subGraphB)}}if(m.length%2!=0)for(var r=0;r<m.length;r++){for(var l=!1,s=0;s<B.length;s++)if(m[r].frequency.label==B[s].frequency.label){l=!0;break}if(!l){var i={subGraphA:m[r],subGraphB:null};e.push(i),B.push(i.subGraphA)}}return e}function i(n){for(var r=0;r<n.length;r++){var t=n[r].subGraphA.attributes,u=new e,o=l(t,u);A.push(o.single),null!=n[r].subGraphB&&(t=n[r].subGraphB.attributes,o=l(t,u),A.push(o.single)),o.multi.nodes.sort(function(n,e){return n.numberOfLinks>e.numberOfLinks?1:n.numberOfLinks<e.numberOfLinks?-1:0});for(var a=0;a<o.multi.nodes.length;a++)N.addNode(o.multi.nodes[a])}}function l(n,e){for(var r=[],t=0;t<n.length;t++)1==n[t].numberOfLinks?r.push(n[t]):e.addNode(n[t]);return{single:r,multi:e}}function f(n){for(var e=h(),r=d(e),t=0,u=0;u<N.nodes.length;u++)N.nodes[u].x=r.column3,N.nodes[u].y=t,t+=p+b,n.addNode(N.nodes[u]);var o=N.nodes.length;t=(o*p+(o-1)*b)/2;for(var u=0;u<B.length;u++){var a=B[u].frequency,s=A[u].length;if(u%2==0){a.x=r.column2;for(var i=0;s>i;i++)A[u][i].x=r.column1}else{a.x=r.column4;for(var i=0;s>i;i++)A[u][i].x=r.column5}u>=2&&(t+=2*e+y),a.y=t;for(var l=t-(s*p+(s-1)*b)/2,i=0;s>i;i++)A[u][i].y=l,n.addNode(A[u][i]),l+=p+b;n.addNode(a)}c(n,e)}function h(){for(var e=n(B[0].frequency.intervals[0].percentage),r=0;r<B.length;r++)for(var t=0;t<B[r].frequency.intervals.length;t++){var u=n(B[r].frequency.intervals[t].percentage);u>e&&(e=u)}return e}function d(n){var e=q/2-v/2,r=e-y-n,t=r-n-y-v,u=e+v+y+n,o=u+n+y;return{column1:t,column2:r,column3:e,column4:u,column5:o}}function c(n,e){var r=B.length-1,t=A[r].length-1,u=[];u.push(A[r][t].y+p),u.push(B[B.length-1].frequency.y+e),u.push(N.nodes[N.nodes.length-1].y+p),B.length>1&&(r=B.length-2,t=A[r].length-1,u.push(A[r][t].y+p),u.push(B[B.length-2].frequency.y+e));for(var o=u[0],a=1;a>u.length;a++)u[a]>o&&(o=u[a]);for(var s=(k-o)/2,a=0;a<n.nodes.length;a++)n.nodes[a].y+=s}function g(n){for(var e=0;e<B.length;e++)for(var r=0;r<B[e].attributes.length;r++)n.link(B[e].frequency,n.nodes[n.getKey(B[e].attributes[r])])}var v=120,p=45,b=15,y=50;e.prototype.getKey=function(n){for(var e=0;e<this.nodes.length;e++){var r=this.nodes[e];if(r.id&&n.id&&r.id===n.id)return e}throw Error("Element not found.")},e.prototype.containsNode=function(n){try{return this.getKey(n),!0}catch(e){return!1}},e.prototype.addNode=function(n){return this.containsNode(n)?this.nodes[this.getKey(n)]:this.nodes.push(n)-1},e.prototype.link=function(n,e){this.links.push({source:n,target:e})};var m,q,k,x=[],G=[],A=[],N=new e,B=[];return{getNodes:r,getLinks:t,buildFromArray:u}}();
var Visualization=function(){"use strict";function t(){p.forEach(function(t){t._ui=l.line(0,0,0,0),t._ui.attr({stroke:"#333"}),t.source._links?t.source._links.push(t):t.source._links=[t],t.target._links?t.target._links.push(t):t.target._links=[t]})}function a(){p.forEach(function(t){t._ui.attr({x1:t.source._ui.getBBox().cx,x2:t.target._ui.getBBox().cx,y1:t.source._ui.getBBox().cy,y2:t.target._ui.getBBox().cy})})}function n(){f.forEach(function(t){var a,n,i=l.group();"frequency"===t.type?(r(t),a=parseFloat(t._ui.attr("cx")),n=parseFloat(t._ui.attr("cy")),i.append(t._ui),i.append(l.text(a-15,n-10,t.intervals[0].percentage.toFixed(2)+"%").addClass("bold")),i.append(l.text(a-25,n+10,"("+t.label+")")),_.push({group:i,node:t})):"attribute"===t.type&&(e(t),a=parseFloat(t._ui.attr("x")),n=parseFloat(t._ui.attr("y")),n+=28,a+=5,i.append(t._ui),i.append(l.text(a,n,t.label))),o(i,t)})}function i(i,e,r){l=i,f=e,p=r,t(),n(),a()}function e(t){t._ui=l.rect(t.x,t.y,120,45),t._ui.attr({fill:"#e74c3c"})}function r(t){var a=Math.pow(t.intervals[0].percentage,4)/30;t._ui=l.circle(t.x,t.y,a),t._ui.attr({fill:"#3498db"})}function o(t,a){t.drag(function(n,i,e,r){this.attr({transform:this.data("transform")+(this.data("transform")?"T":"t")+[n,i]}),a.x=e,a.y=r;var o=t.getBBox();a._links.forEach(function(t){t.source===a?t._ui.attr({x1:o.cx,y1:o.cy}):t.target===a&&t._ui.attr({x2:o.cx,y2:o.cy})})},function(){this.data("transform",this.transform().local)})}function u(t,a){1==parseInt(a.attr("opacity"))&&(a.animate({opacity:0},500,mina.easeinout),t._links.forEach(function(t){1===t.target.numberOfLinks&&t.target._ui.animate({opacity:0},500,mina.easeinout);t.target.label,t.target.numberOfLinks;t.target.numberOfLinks--,t._ui.animate({opacity:0},500,mina.easeinout)}))}function c(t,a){0===parseInt(a.attr("opacity"))&&(a.animate({opacity:1},500,mina.easeinout),t._links.forEach(function(t){0===t.target.numberOfLinks&&t.target._ui.animate({opacity:1},500,mina.easeinout);t.target.label,t.target.numberOfLinks;t.target.numberOfLinks++,t._ui.animate({opacity:1},500,mina.easeinout)}))}function s(t,a){_.forEach(function(n){var i=n.node.intervals;i[t]&&(i[t].percentage<a?u(n.node,n.group):c(n.node,n.group))})}var f,p,l,_=[];return{start:i,step:s}}();
var Hypergraph=function(t){"use strict";function n(t){t||(t="data.json");var n=new XMLHttpRequest;n.open("GET",t,!0),n.onload=function(){if(this.status>=200&&this.status<400){var t=JSON.parse(this.response);t.forEach(function(t){var n=t.frequency;f=n.intervals.length>f?n.intervals.length:f}),w.buildFromArray(t,g,p),e()}},n.send()}function e(){var t=w.getNodes(),n=w.getLinks(),e=document.createElementNS("http://www.w3.org/2000/svg","svg");e.setAttribute("height",p),e.setAttribute("width",g),v.appendChild(e),s=Visualization,s.start(new Snap(e),t,n)}function i(){u||(u=!u,h=window.setInterval(o,c))}function r(){u&&(u=!u,window.clearInterval(h),h=null)}function a(t){return c=t,u&&(r(),i()),c}function o(){d===f?(document.dispatchEvent(new Event("animation.finished")),window.clearInterval(h),d=0,u=!1):s.step(d++,l)}var s,u=!1,c=1e3,l=6.25,d=0,h=null,f=0,w=t,v=null,p=0,g=0;return{start:function(t,e){v=document.querySelector(t),p=window.innerHeight,g=v.offsetWidth,n(e)},isPlaying:function(){return u},play:i,pause:r,changeVelocity:a,setThreshold:function(t){l=t}}}(LayoutEngine);