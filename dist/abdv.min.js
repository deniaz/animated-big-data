...
var Visualization=function(){"use strict";function t(){_.forEach(function(t){t._ui=p.line(0,0,0,0),t._ui.attr({stroke:"#333"}),t.source._links?t.source._links.push(t):t.source._links=[t],t.target._links?t.target._links.push(t):t.target._links=[t]})}function a(){_.forEach(function(t){t._ui.attr({x1:t.source._ui.getBBox().cx,x2:t.target._ui.getBBox().cx,y1:t.source._ui.getBBox().cy,y2:t.target._ui.getBBox().cy})})}function i(){f.forEach(function(t){var a,i,n=p.group();"frequency"===t.type?(r(t),a=t._ui.attr("cx"),i=t._ui.attr("cy"),a-=25,n.append(t._ui),n.append(p.text(a,i,t.label)),l.push({group:n,node:t})):"attribute"===t.type&&(e(t),a=parseFloat(t._ui.attr("x")),i=parseFloat(t._ui.attr("y")),i+=28,a+=5,n.append(t._ui),n.append(p.text(a,i,t.label))),o(n,t)})}function n(n,e,r){p=n,f=e,_=r,t(),i(),a()}function e(t){t._ui=p.rect(t.x,t.y,120,45),t._ui.attr({fill:"#e74c3c"})}function r(t){var a=Math.pow(t.intervals[0].percentage,4)/30;t._ui=p.circle(t.x,t.y,a),t._ui.attr({fill:"#3498db"})}function o(t,a){t.drag(function(i,n,e,r){this.attr({transform:this.data("transform")+(this.data("transform")?"T":"t")+[i,n]}),a.x=e,a.y=r;var o=t.getBBox();a._links.forEach(function(t){t.source===a?t._ui.attr({x1:o.cx,y1:o.cy}):t.target===a&&t._ui.attr({x2:o.cx,y2:o.cy})})},function(){this.data("transform",this.transform().local)})}function u(t,a){1==a.attr("opacity")&&(a.animate({opacity:0},1e3,mina.easeinout),t._links.forEach(function(t){1===t.target.numberOfLinks&&t.target._ui.animate({opacity:0},1e3,mina.easeinout),t.target.numberOfLinks--,t._ui.animate({opacity:0},1e3,mina.easeinout)}))}function c(t,a){0==a.attr("opacity")&&(a.animate({opacity:1},1e3,mina.easeinout),t._links.forEach(function(t){0===t.target.numberOfLinks&&t.target._ui.animate({opacity:1},1e3,mina.easeinout),t.target.numberOfLinks++,t._ui.animate({opacity:1},1e3,mina.easeinout)}))}function s(t,a){l.forEach(function(i){var n=i.node.intervals;n[t]&&(n[t].percentage<a?u(i.node,i.group):c(i.node,i.group))})}var f,_,p,l=[];return{start:n,step:s}}();
var Hypergraph=function(t){"use strict";function n(t){t||(t="data.json");var n=new XMLHttpRequest;n.open("GET",t,!0),n.onload=function(){if(this.status>=200&&this.status<400){var t=JSON.parse(this.response);t.forEach(function(t){var n=t.frequency;f=n.intervals.length>f?n.intervals.length:f}),v.buildFromArray(t,g,p),e()}},n.send()}function e(){var t=v.getNodes(),n=v.getLinks(),e=document.createElementNS("http://www.w3.org/2000/svg","svg");e.setAttribute("height",p),e.setAttribute("width",g),w.appendChild(e),s=Visualization,s.start(Snap(e),t,n)}function i(){u||(u=!u,h=window.setInterval(o,c))}function r(){u&&(u=!u,window.clearInterval(h),h=null)}function a(t){return c=t,u&&(r(),i()),c}function o(){d===f?(document.dispatchEvent(new Event("animation.finished")),window.clearInterval(h),d=0,u=!1):s.step(d++,l)}var s,u=!1,c=1e3,l=6.25,d=0,h=null,f=0,v=t,w=null,p=0,g=0;return{start:function(t,e){w=document.querySelector(t),p=window.innerHeight,g=w.offsetWidth,n(e)},isPlaying:function(){return u},play:i,pause:r,changeVelocity:a,setThreshold:function(t){return l=t}}}(LayoutEngine);