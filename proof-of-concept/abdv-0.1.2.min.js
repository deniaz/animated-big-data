...
var Controls=function(){"use strict";function t(t,e,a){document.querySelector(t).addEventListener(e,a)}function e(){var t=document.querySelector(".js-play-label"),e=t.getAttribute("data-alt-text");t.setAttribute("data-alt-text",t.textContent),t.textContent=e;var a=document.querySelector(".js-play"),n=a.getAttribute("data-alt-symbol");a.setAttribute("data-alt-symbol",a.getAttribute("value")),a.setAttribute("value",n)}function a(a){document.addEventListener("animation.finished",e),t(".js-play","click",function(){e(),a.isPlaying()?a.pause():a.play()}),t(".js-velocity","change",function(t){var e=document.querySelector(".js-velocity-label");e.textContent=t.target.value,a.changeVelocity(t.target.value)}),t(".js-threshold","change",function(t){var e=document.querySelector(".js-threshold-label");e.textContent=t.target.value,a.setThreshold(t.target.value)})}return{start:a}}();
var LayoutEngine=function(){"use strict";function n(){this.nodes=[],this.links=[]}function e(){return B}function r(){return G}function t(e,r,t,i){q=u(e),k=r,N=t,L=i;var a=o(),f=s(a);l(f);var d=new n;h(d),y(d),B=d.nodes,G=d.links}function u(e){var r=new n,t=[];return e.forEach(function(n){for(var e=n[n.length-1],u=[],o=0;o<n.length-1;o++){var i;r.containsNode(n[o])?(i=r.nodes[r.getKey(n[o])],i.numberOfLinks++):(i=r.nodes[r.nodes.push(n[o])-1],i.numberOfLinks=1),u.push(i)}t.push({frequency:e,attributes:u})}),t}function o(){for(var n=[],e=0;e<q.length-1;e++)for(var r=e+1;r<q.length;r++){var t={indexA:e,indexB:r,equal:i(q[e],q[r])};n.push(t)}return n.forEach(function(n,e){n.index=e}),n.sort(function(n,e){return n.equal<e.equal?1:n.equal>e.equal?-1:n.index<e.index?-1:n.index>e.index?1:0}),n}function i(n,e){for(var r=0,t=0;t<n.attributes.length;t++)for(var u=0;u<e.attributes.length;u++)if(e.attributes[u].id==n.attributes[t].id){r++;break}return r}function s(n){for(var e=[],r=0;r<n.length;r++){for(var t=n[r],u=q[t.indexA].frequency,o=q[t.indexB].frequency,i=!1,s=0;s<E.length;s++)if(E[s].frequency.label==u.label||E[s].frequency.label==o.label){i=!0;break}i||e.push(a(q[t.indexA],q[t.indexB]))}if(q.length%2!==0)for(var r=0;r<q.length;r++){for(var l=!1,s=0;s<E.length;s++)if(q[r].frequency.label==E[s].frequency.label){l=!0;break}l||e.push(a(q[r],null))}return e}function a(n,e){var r={subGraphA:n,subGraphB:e};return E.push(r.subGraphA),null!==r.subGraphB&&E.push(r.subGraphB),r}function l(e){for(var r=0;r<e.length;r++){var t=e[r].subGraphA.attributes,u=new n,o=f(t,u);A.push(o.single),null!==e[r].subGraphB&&(t=e[r].subGraphB.attributes,o=f(t,u),A.push(o.single)),o.multi.nodes.forEach(function(n,e){n.index=e}),o.multi.nodes.sort(function(n,e){return n.numberOfLinks>e.numberOfLinks?1:n.numberOfLinks<e.numberOfLinks?-1:n.index>e.index?1:n.index<e.index?-1:0});for(var i=0;i<o.multi.nodes.length;i++)O.addNode(o.multi.nodes[i])}}function f(n,e){for(var r=[],t=0;t<n.length;t++)1==n[t].numberOfLinks?r.push(n[t]):e.addNode(n[t]);return{single:r,multi:e}}function h(n){for(var e,r=d(),t=g(r),u=0,o=0,i=0,s=0;s<E.length;s++){var a=E[s].frequency,l=A[s].length,f=c(a);if(s%2===0){a.x=t.column2,a.y=u+=f+x,e=u-(l*b+(l-1)*m)/2;for(var h=0;l>h;h++)A[s][h].x=t.column1,A[s][h].y=e,n.addNode(A[s][h]),e+=b+m;u+=f}else{a.x=t.column4,a.y=o+=f+x,e=o-(l*b+(l-1)*m)/2;for(var h=0;l>h;h++)A[s][h].x=t.column5,A[s][h].y=e,n.addNode(A[s][h]),e+=b+m;o+=f}n.addNode(a),a.y>i&&(i=a.y)}var y=O.nodes.length;e=i/2-(y*b+(y-1)*m)/2;for(var s=0;s<O.nodes.length;s++)O.nodes[s].x=t.column3,O.nodes[s].y=e,e+=b+m,n.addNode(O.nodes[s]);v(n,r)}function d(){for(var n=0,e=0;e<E.length;e++){var r=c(E[e].frequency);r>n&&(n=r)}return n}function c(n){for(var e=0,r=0;r<n.intervals.length;r++){var t=L(n.intervals[r].percentage);t>e&&(e=t)}return e}function g(n){var e=k/2-p/2,r=e-x-n,t=r-n-x-p,u=e+p+x+n,o=u+n+x;return{column1:t,column2:r,column3:e,column4:u,column5:o}}function v(n,e){var r=E.length-1,t=A[r].length-1,u=[];u.push(A[r][t].y+b),u.push(E[E.length-1].frequency.y+e),u.push(O.nodes[O.nodes.length-1].y+b),E.length>1&&(r=E.length-2,t=A[r].length-1,u.push(A[r][t].y+b),u.push(E[E.length-2].frequency.y+e));for(var o=u[0],i=1;i>u.length;i++)u[i]>o&&(o=u[i]);for(var s=(N-o)/2,i=0;i<n.nodes.length;i++)n.nodes[i].y+=s}function y(n){for(var e=0;e<E.length;e++)for(var r=0;r<E[e].attributes.length;r++)try{n.link(E[e].frequency,n.nodes[n.getKey(E[e].attributes[r])])}catch(t){}}var p=120,b=45,m=15,x=50;n.prototype.getKey=function(n){for(var e=0;e<this.nodes.length;e++){var r=this.nodes[e];if(r.id&&n.id&&r.id===n.id)return e}throw Error("Element not found.")},n.prototype.containsNode=function(n){try{return this.getKey(n),!0}catch(e){return!1}},n.prototype.addNode=function(n){return this.containsNode(n)?this.nodes[this.getKey(n)]:this.nodes[this.nodes.push(n)-1]},n.prototype.link=function(n,e){this.links.push({source:n,target:e})};var q,k,N,L,B=[],G=[],A=[],O=new n,E=[];return{getNodes:e,getLinks:r,buildFromArray:t}}();
var Visualization=function(){"use strict";function t(t){y=t.paper,k=t.nodes,x=t.links,V=t.normalize,E=t.threshold,e(),i(),T.forEach(function(t){d(t._node)&&m(t),u(t),l(t)})}function e(){x.forEach(function(t){var e=t.source.x,i=t.source.y,n=t.target.x,a=t.target.y;"attribute"===t.source.type&&(e+=q/2,i+=C/2),"attribute"===t.target.type&&(n+=q/2,a+=C/2);var r=y.line(e,i,n,a);r.attr({stroke:B,opacity:0}),t._ui=r,t.source._links?t.source._links.push(t):t.source._links=[t],t.target._links?t.target._links.push(t):t.target._links=[t]})}function i(){k.forEach(function(t){var e=n();"frequency"===t.type?(e.append(a(t)),e.append(o(t)),e.append(s(t))):"attribute"===t.type&&(t.activeLinks=0,e.append(r(t)),e.append(c(t))),t._ui=e,e._node=t,T.push(e)})}function n(){var t=y.group();return t.attr({opacity:0}),t._isVisible=!1,t}function a(t){var e=V(t.intervals[0].percentage),i=y.circle(t.x,t.y,e);return i.attr({fill:F}),i}function r(t){var e=y.rect(t.x,t.y,q,C);return e.attr({fill:z}),e}function o(t,e){e||(e=0);var i=t.intervals[e].percentage.toFixed(2)+"%";return y.text(t.x-15,t.y-10,i).addClass("bold percentage")}function s(t,e){e||(e=0);var i="("+t.intervals[e].label+")";return y.text(t.x-25,t.y+10,i).addClass("freq-id")}function c(t){return y.text(t.x+10,t.y+28,t.label)}function u(t){var e=t._node;t.drag(function(i,n,a,r){this.attr({transform:this.data("transform")+(this.data("transform")?"T":"t")+[i,n]}),e.x=a,e.y=r;var o=t.getBBox();e._links.forEach(function(t){t.source===e?t._ui.attr({x1:o.cx,y1:o.cy}):t.target===e&&t._ui.attr({x2:o.cx,y2:o.cy})})},function(){this.data("transform",this.transform().local)})}function l(t){"frequency"===t._node.type?f(t):_(t)}function f(t){var e=t.select("circle"),i=t._node._links.map(function(t){return t.target._ui.select("rect")}),n=t._node._links.map(function(t){return t._ui});t.hover(function(){t._isVisible&&(e.animate({fill:L},250,mina.easeinout),i.forEach(function(t){t.animate({fill:W},250,mina.easeinout)}),n.forEach(function(t){t.animate({stroke:A,strokeWidth:2},250,mina.easeinout)}))},function(){e.animate({fill:F},250,mina.easeinout),i.forEach(function(t){t.animate({fill:z},250,mina.easeinout)}),n.forEach(function(t){t.animate({stroke:B,strokeWidth:1},250,mina.easeinout)})})}function _(t){var e=t.select("rect"),i=t._node._links.map(function(t){return t.source._ui.select("circle")}),n=t._node._links.map(function(t){return t._ui});t.hover(function(){t._isVisible&&(e.animate({fill:W},250,mina.easeinout),i.forEach(function(t){t.animate({fill:L},250,mina.easeinout)}),n.forEach(function(t){t.animate({stroke:A,strokeWidth:2},250,mina.easeinout)}))},function(){e.animate({fill:z},250,mina.easeinout),i.forEach(function(t){t.animate({fill:F},250,mina.easeinout)}),n.forEach(function(t){t.animate({stroke:B,strokeWidth:1},250,mina.easeinout)})})}function d(t,e){return e||(e=0),"frequency"===t.type&&t.intervals[e]?t.intervals[e].percentage>=E:!1}function m(t){t._isVisible||v(t)}function p(t){t._isVisible&&v(t)}function v(t){t._isVisible=!t._isVisible,t._node._links.forEach(function(e){var i=!t._isVisible&&1===e.target.activeLinks||t._isVisible&&0===e.target.activeLinks;i&&(e.target._ui.animate({opacity:t._isVisible?1:0},500,mina.easeinout).toggleClass("is-visible"),e.target._ui._isVisible=t._isVisible),t._isVisible?e.target.activeLinks++:e.target.activeLinks--,e._ui.animate({opacity:t._isVisible?1:0},500,mina.easeinout)}),t.animate({opacity:t._isVisible?1:0},500,mina.easeinout).toggleClass("is-visible")}function h(t,e){var i=V(t._node.intervals[e].percentage);t.select("circle").animate({r:i},500,mina.easeinout)}function b(t,e){var i=t.select(".percentage");i.node.textContent=t._node.intervals[e].percentage.toFixed(2)+"%";var n=t.select(".freq-id");n.node.textContent="("+t._node.intervals[e].label+")"}function g(t){T.forEach(function(e){"frequency"===e._node.type&&(e._node.intervals[t]&&(b(e,t),h(e,t)),d(e._node,t)?m(e):p(e))})}var y,k,x,V,E,q=120,C=45,L="#4DAEF0",F="#2980b9",W="#FA5746",z="#c0392b",A="#9b59b6",B="#2c3e50",T=[];return{start:t,next:g,setThreshold:function(t){E=t}}}();
var Hypergraph=function(t){"use strict";function e(t){t||(t="data.json"),t+="?_"+(new Date).getTime();var e=new XMLHttpRequest;e.open("GET",t,!0),e.onload=function(){if(this.status>=200&&this.status<400){var t=JSON.parse(this.response);t.forEach(function(t){var e=t[t.length-1];p=e.intervals.length>p?e.intervals.length-1:p}),document.querySelector(".max-steps").textContent="/"+(p+1),document.querySelector(".step-progress").setAttribute("max",p),f.buildFromArray(t,w,v,m),n()}},e.send()}function n(){var t=f.getNodes(),e=f.getLinks(),n=document.createElementNS("http://www.w3.org/2000/svg","svg");n.setAttribute("height",v),n.setAttribute("width",w),g.appendChild(n),i=Visualization,i.start({paper:new Snap(n),nodes:t,links:e,normalize:m,threshold:l})}function r(){a||(a=!a,h=window.setInterval(u,c))}function o(){a&&(a=!a,window.clearInterval(h),h=null)}function s(t){return c=t,a&&(o(),r()),c}function u(){d===p?(document.dispatchEvent(new Event("animation.finished")),window.clearInterval(h),d=0,a=!1,i.next(d),document.querySelector(".current-step").textContent=d+1,document.querySelector(".step-progress").setAttribute("value",0)):(i.next(++d),document.querySelector(".current-step").textContent=d+1,document.querySelector(".step-progress").setAttribute("value",d))}var i,a=!1,c=2500,l=5,d=0,h=null,p=0,f=t,g=null,v=0,w=0,m=function(t){return 7*t};return{start:function(t,n){g=document.querySelector(t),v=window.innerHeight-45,w=g.offsetWidth,e(n)},isPlaying:function(){return a},play:r,pause:o,changeVelocity:s,setThreshold:function(t){l=t,i.setThreshold(t),i.next(d)}}}(LayoutEngine);