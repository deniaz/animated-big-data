...
var Hypergraph=function(t){"use strict";function n(t){t||(t="data.json");var n=new XMLHttpRequest;n.open("GET",t,!0),n.onload=function(){if(this.status>=200&&this.status<400){var t=JSON.parse(this.response);t.forEach(function(t){var n=t[t.length-1];f=n.intervals.length>f?n.intervals.length-1:f}),w.buildFromArray(t,g,v,m),e()}},n.send()}function e(){var t=w.getNodes(),n=w.getLinks(),e=document.createElementNS("http://www.w3.org/2000/svg","svg");e.setAttribute("height",v),e.setAttribute("width",g),p.appendChild(e),s=Visualization,s.start({paper:new Snap(e),nodes:t,links:n,normalize:m,threshold:c})}function i(){u||(u=!u,d=window.setInterval(a,l))}function r(){u&&(u=!u,window.clearInterval(d),d=null)}function o(t){return l=t,u&&(r(),i()),l}function a(){h===f?(document.dispatchEvent(new Event("animation.finished")),window.clearInterval(d),h=0,u=!1,s.next(h)):s.next(++h)}var s,u=!1,l=2500,c=5,h=0,d=null,f=0,w=t,p=null,v=0,g=0,m=function(t){return 7*t};return{start:function(t,e){p=document.querySelector(t),v=window.innerHeight,g=p.offsetWidth,n(e)},isPlaying:function(){return u},play:i,pause:r,changeVelocity:o,setThreshold:function(t){c=t,s.setThreshold(t)}}}(LayoutEngine);