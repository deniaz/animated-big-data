...
var Visualization=function(){"use strict";function t(t){y=t.paper,b=t.nodes,x=t.links,h=t.normalize,k=t.threshold,e(),i(),L.forEach(function(t){l(t._node)&&f(t),u(t)})}function e(){x.forEach(function(t){var e=t.source.x,i=t.source.y,n=t.target.x,a=t.target.y;"attribute"===t.source.type&&(e+=m/2,i+=V/2),"attribute"===t.target.type&&(n+=m/2,a+=V/2);var r=y.line(e,i,n,a);r.attr({stroke:q,opacity:0}),t._ui=r,t.source._links?t.source._links.push(t):t.source._links=[t],t.target._links?t.target._links.push(t):t.target._links=[t]})}function i(){b.forEach(function(t){var e=n();"frequency"===t.type?(e.append(a(t)),e.append(s(t)),e.append(o(t))):"attribute"===t.type&&(t.activeLinks=0,e.append(r(t)),e.append(c(t))),t._ui=e,e._node=t,L.push(e)})}function n(){var t=y.group();return t.attr({opacity:0}),t._isVisible=!1,t}function a(t){var e=h(t.intervals[0].percentage),i=y.circle(t.x,t.y,e);return i.attr({fill:C}),i}function r(t){var e=y.rect(t.x,t.y,m,V);return e.attr({fill:E}),e}function s(t,e){e||(e=0);var i=t.intervals[e].percentage.toFixed(2)+"%";return y.text(t.x-15,t.y-10,i).addClass("bold percentage")}function o(t,e){e||(e=0);var i="("+t.intervals[e].label+")";return y.text(t.x-25,t.y+10,i).addClass("freq-id")}function c(t){return y.text(t.x+10,t.y+28,t.label)}function u(t){var e=t._node;t.drag(function(i,n,a,r){this.attr({transform:this.data("transform")+(this.data("transform")?"T":"t")+[i,n]}),e.x=a,e.y=r;var s=t.getBBox();e._links.forEach(function(t){t.source===e?t._ui.attr({x1:s.cx,y1:s.cy}):t.target===e&&t._ui.attr({x2:s.cx,y2:s.cy})})},function(){this.data("transform",this.transform().local)})}function l(t,e){return e||(e=0),"frequency"===t.type&&t.intervals[e]?t.intervals[e].percentage>=k:!1}function f(t){t._isVisible||d(t)}function _(t){t._isVisible&&d(t)}function d(t){t._isVisible=!t._isVisible,t.animate({opacity:t._isVisible?1:0},500,mina.easeinout).toggleClass("is-visible"),t._node._links.forEach(function(e){var i=!t._isVisible&&1===e.target.activeLinks||t._isVisible&&0===e.target.activeLinks;i&&e.target._ui.animate({opacity:t._isVisible?1:0},500,mina.easeinout).toggleClass("is-visible"),t._isVisible?e.target.activeLinks++:e.target.activeLinks--,e._ui.animate({opacity:t._isVisible?1:0},500,mina.easeinout)})}function p(t,e){var i=h(t._node.intervals[e].percentage);t.select("circle").animate({r:i},500,mina.easeinout)}function v(t,e){var i=t.select(".percentage");i.node.textContent=t._node.intervals[e].percentage.toFixed(2)+"%";var n=t.select(".freq-id");n.node.textContent="("+t._node.intervals[e].label+")"}function g(t){L.forEach(function(e){"frequency"===e._node.type&&(e._node.intervals[t]&&(v(e,t),p(e,t)),l(e._node,t)?f(e):_(e))})}var y,b,x,h,k,m=120,V=45,C="#3498db",E="#e74c3c",q="#34495e",L=[];return{start:t,next:g,setThreshold:function(t){k=t}}}();
