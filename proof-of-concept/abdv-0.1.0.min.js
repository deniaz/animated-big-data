...
var Visualization=function(){"use strict";function t(){l.forEach(function(t){t._ui=_.line(0,0,0,0),t._ui.attr({stroke:"#333"}),t.source._links?t.source._links.push(t):t.source._links=[t],t.target._links?t.target._links.push(t):t.target._links=[t]})}function a(){l.forEach(function(t){t._ui.attr({x1:t.source._ui.getBBox().cx,x2:t.target._ui.getBBox().cx,y1:t.source._ui.getBBox().cy,y2:t.target._ui.getBBox().cy})})}function n(){p.forEach(function(t){var a,n,e=_.group();if("frequency"===t.type){var u=t.intervals[0];r(t),a=parseFloat(t._ui.attr("cx")),n=parseFloat(t._ui.attr("cy")),e.append(t._ui),e.append(_.text(a-15,n-10,u.percentage.toFixed(2)+"%").addClass("bold percentage")),e.append(_.text(a-25,n+10,"("+u.label+")").addClass("id-label")),0===u.percentage&&c(t,e,0),d.push({group:e,node:t})}else"attribute"===t.type&&(i(t),a=parseFloat(t._ui.attr("x")),n=parseFloat(t._ui.attr("y")),n+=28,a+=5,e.append(t._ui),e.append(_.text(a,n,t.label)));o(e,t)})}function e(e,i,r,o){_=e,p=i,l=r,g=o,t(),n(),a()}function i(t){t._ui=_.rect(t.x,t.y,120,45),t._ui.attr({fill:"#e74c3c"})}function r(t){var a=g(t.intervals[0].percentage);t._ui=_.circle(t.x,t.y,a),t._ui.attr({fill:"#3498db"})}function o(t,a){t.drag(function(n,e,i,r){this.attr({transform:this.data("transform")+(this.data("transform")?"T":"t")+[n,e]}),a.x=i,a.y=r;var o=t.getBBox();a._links.forEach(function(t){t.source===a?t._ui.attr({x1:o.cx,y1:o.cy}):t.target===a&&t._ui.attr({x2:o.cx,y2:o.cy})})},function(){this.data("transform",this.transform().local)})}function u(t,a,n){var e=t.children().filter(function(t){return"text"===t.type});e.forEach(function(t){var e=t.node;e.classList.contains("percentage")?e.textContent=a+"%":e.classList.contains("id-label")&&(e.textContent=n)})}function c(t,a,n){"undefined"==typeof n&&(n=500),1==parseInt(a.attr("opacity"))&&(a.animate({opacity:0},n,mina.easeinout),t._links.forEach(function(t){1===t.target.numberOfLinks&&t.target._ui.animate({opacity:0},n,mina.easeinout),t.target.numberOfLinks--,t._ui.animate({opacity:0},n,mina.easeinout)}))}function s(t,a){0===parseInt(a.attr("opacity"))&&(a.animate({opacity:1},500,mina.easeinout),t._links.forEach(function(t){0===t.target.numberOfLinks&&t.target._ui.animate({opacity:1},500,mina.easeinout),t.target.numberOfLinks++,t._ui.animate({opacity:1},500,mina.easeinout)}))}function f(t,a){d.forEach(function(n){var e=n.node.intervals;e[t]&&(e[t].percentage<a?c(n.node,n.group):s(n.node,n.group),n.node._ui.animate({r:g(e[t].percentage)},500,mina.easeinout),u(n.group,e[t].percentage,e[t].label))})}var p,l,_,g,d=[];return{start:e,step:f}}();
var Hypergraph=function(t){"use strict";function n(t){t||(t="data.json");var n=new XMLHttpRequest;n.open("GET",t,!0),n.onload=function(){if(this.status>=200&&this.status<400){var t=JSON.parse(this.response);t.forEach(function(t){var n=t[t.length-1];f=n.intervals.length>f?n.intervals.length:f}),w.buildFromArray(t,g,v,function(t){return t}),e()}},n.send()}function e(){var t=w.getNodes(),n=w.getLinks(),e=document.createElementNS("http://www.w3.org/2000/svg","svg");e.setAttribute("height",v),e.setAttribute("width",g),p.appendChild(e),u=Visualization,u.start(new Snap(e),t,n,function(t){return Math.pow(t,2)})}function i(){s||(s=!s,d=window.setInterval(o,c))}function r(){s&&(s=!s,window.clearInterval(d),d=null)}function a(t){return c=t,s&&(r(),i()),c}function o(){h===f?(document.dispatchEvent(new Event("animation.finished")),window.clearInterval(d),h=0,s=!1):u.step(h++,l)}var u,s=!1,c=2500,l=6.25,h=0,d=null,f=0,w=t,p=null,v=0,g=0;return{start:function(t,e){p=document.querySelector(t),v=window.innerHeight,g=p.offsetWidth,n(e)},isPlaying:function(){return s},play:i,pause:r,changeVelocity:a,setThreshold:function(t){l=t}}}(LayoutEngine);